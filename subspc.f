...
c          set directory path location to GLOBE data base
         path='E:\GLOBE\'        !  (PC systems use '\')
	 nchp=9               !  number of characters in path
...
c          The following lines should be uncommented for unix systems.
c***********************************************************
cc      byte1=iand(data,255)                !  byte swap for unix systems
cc      byte2=ibits(data,8,8)               !  extract the upper 8 bits
...
cc      data=byte1*256 + byte2              !  byte swap
c***********************************************************
